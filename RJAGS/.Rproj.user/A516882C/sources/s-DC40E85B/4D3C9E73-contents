...
parameters= c("alpha","beta","alpha.c","beta.c","tau.c","alpha.tau","beta.tau")
...
first.model=bugs(data=rats, inits=initial.values, parameters.to.save=parameters, model.file="model.txt", n.chains=3, bugs.directory = "C:/Users/giaco/Documents/winbugs/WinBUGS14", working.directory="C:/Users/giaco/Documents/GitHub/BayesianProject/RJAGS", n.burnin = 1000, n.iter=11000)

first.model$summary[c('alpha0','alpha1','alpha2','alpha12','sigma'),c("mean","sd","Rhat","n.eff")]
